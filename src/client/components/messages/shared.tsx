...
export function getNextExpandableRowExpandedState(_expanded: boolean, isExpanded: boolean) {
  return !isExpanded
}
...
export function ExpandableRow({ children, expandedContent, defaultExpanded = false, forceExpanded = false }: ExpandableRowProps) {
  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <button
        onClick={() => setExpanded(getNextExpandableRowExpandedState(expanded, isExpanded))}
